...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Big Box Coin 2018 really";
        CTransaction txNew;
        txNew.nTime = 1525695833;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1525695833;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 696716 : 696716;
        ...
        assert(block.hashMerkleRoot == uint256("0xc6f05f6ac5098c45b95705c0cfeccbbd28db82655fe7988398a0851bdeb2e480"));
